...
public class Colors {
    ...
    public static int[] colors = {Color.BLUE, Color.parseColor("#FFD900"), Color.parseColor("#ff99ff"),Color.parseColor("#007000"), Color.BLACK,Color.CYAN,Color.DKGRAY, Color.parseColor("#ffa500"), 0};
